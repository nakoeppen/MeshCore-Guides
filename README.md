...
| Device | MCU | Radio | Display | Enclosed | Solar | Battery | WiFi | Bluetooth | GPS |
| ------ | --- | ----- | ------- | --------- | ------------- | ------- | ---- | --------- | ----------- |
| Heltec v3 | ESP32 | SX1262 | ✅ | ❌ | ❌ | Optional | ✅ | ✅ | Yes (external, soldering) |
| Heltec v4 | ESP32-S3 | SX1262 | Optional | ❌ | Optional | Optional | ✅ | ✅ | Yes (integrated port) |
| Heltec T114 | nRF52840 | SX1262 | Optional | ❌ | Optional | Optional | ❌ | ✅ | Yes (integrated port) |
| RAK WisBlock | nRF52840 | SX1262 | ❌ | ❌ | Optional | Optional | ❌ | ✅ | Yes |
